...
public class Buscar extends javax.swing.JFrame {
	...
	private void buscarAnimalesActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_buscarAnimalesActionPerformed
	...
	public static void main() {
		try {
			...
			java.util.logging.Logger.getLogger(Buscar.class.getName()).log(
